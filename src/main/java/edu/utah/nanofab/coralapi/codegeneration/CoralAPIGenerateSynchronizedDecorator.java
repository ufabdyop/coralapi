 ...
 *
 */
public class CoralAPIGenerateSynchronizedDecorator
{
   private CoralAPIGenerateSynchronizedDecorator() {}
      ...
      if (javaSource instanceof MethodHolderSource)
      {
         ...
         for (MethodSource method : methods)
         {
            ...
            MethodSource<JavaClassSource> decoratorMethod = decoratorClass
                     .addMethod().setPublic().setSynchronized(true).setName(method.getName());
